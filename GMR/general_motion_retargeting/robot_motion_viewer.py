...
class RobotMotionViewer:
    def __init__(self,
                ...
                headless=False,  # NEW: enable headless mode (no viewer window)
                ):
        ...
        # Only launch interactive viewer if not in headless mode
        ...
        # Initialize renderer for video recording or headless mode
        if self.record_video or self.headless:
    ...
    def step(self,
        ...
        # Only update viewer if not in headless mode
        if not self.headless:
